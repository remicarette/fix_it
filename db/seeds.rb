...
create_booking(thema,chirac,'error 404','elle tombe toujours en panne','2019/08/31 07:00','2019/08/31 08:00')
create_booking(thema,chirac,'error 404','elle tombe toujours en panne','2019/08/31 08:00','2019/08/31 08:00')
create_booking(thema,chirac,'error 404','elle tombe toujours en panne','2019/08/31 09:00','2019/08/31 08:00')
create_booking(thema,chirac,'error 404','elle tombe toujours en panne','2019/08/31 11:00','2019/08/31 08:00')
create_booking(thema,chirac,'error 404','elle tombe toujours en panne','2019/08/31 12:00','2019/08/31 08:00')
create_booking(thema,chirac,'error 404','elle tombe toujours en panne','2019/08/31 13:00','2019/08/31 08:00')
create_booking(thema,chirac,'error 404','elle tombe toujours en panne','2019/08/31 15:00','2019/08/31 08:00')
create_booking(thema,chirac,'error 404','elle tombe toujours en panne','2019/08/31 16:00','2019/08/31 08:00')
create_booking(thema,chirac,'error 404','elle tombe toujours en panne','2019/08/31 18:00','2019/08/31 08:00')
create_booking(thema,chirac,'error 404','elle tombe toujours en panne','2019/08/31 19:00','2019/08/31 08:00')
create_booking(thema,chirac,'error 404','elle tombe toujours en panne','2019/08/31 20:00','2019/08/31 08:00')
